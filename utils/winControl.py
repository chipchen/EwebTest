...
class WinControl(object):
    ...
    def getPos(self):
        ...
        '''
        print(autoit.win_get_pos(self.title, text=self.text))
    ...
    def getProcess(self):
        ...
        :return PID:成功, -1:失败.
        '''
        print(autoit.win_get_process(self.title, text=self.text))
    ...
    def controlFocus(self, control):
        ...
        :return 1:成功; 0:失败.
        '''
        print(autoit.control_focus(self.title, control, text=self.text))
    ...
    def controlSend(self, control, send_text, mode=0):
        ...
        '''
        print(autoit.control_send(self.title, control, send_text, mode, text=self.text))
    ...
    def controlSetText(self, control, control_text):
        ...
        :return 1:成功; 0:失败(窗口/控件未找到).
        '''
        # print(autoit.control_set_text(self.title, control, control_text, text=self.text))
