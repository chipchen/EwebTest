...
class PageObject:
    ...
    def switch_to_default_content(self):
        """
        Swithes focus to the default context.
        Corresponding relationship with switch_to_frame () method.
        """
...
class PageElement(object):
    ...
    def get_element(self, context):
        try:
            ...
            return WebDriverWait(context, 20).until(lambda x: x.find_element(*self.locator))
...
class PageElements(PageElement):
    ...
    def find(self, context):
        try:
            ...
            return WebDriverWait(context, 20).until(lambda x: x.find_elements(*self.locator))
        except NoSuchElementException:
            return []
